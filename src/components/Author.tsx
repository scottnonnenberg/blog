...
const THE_URL = 'https://scottnonnenberg.com/work/#social-security-administration-2015-q-3';
...
export default function Author() {
  ...
  return <div className="author">
    ...
    /></a>
    <div>
      Hi, I'm <a href={HOMEPAGE_URL}><strong>Scott</strong></a>.

      I've written both server and client code in
      {' '}<Link to={MANY_LANGUAGES_URL}>many languages</Link>
      {' '}for <a href={WORK_URL}>many employers and clients</a>.

      I've also got a bit of an <Link to={UNUSUAL_URL}>unusual</Link>
      {' '}<Link to={PERSPECTIVE_URL}>perspective</Link>,
      since I've spent time in <a href={ROLES_URL}>roles</a>
